            ...
            <div class="col-sm-3">
                <div class="pd-20" >
                    <div class="col-xl-12 mb-1"  style="float:right">
                      <a class="btn btn-sm btn-success" href="<?= base_url("manage-staf/tambah") ?>" style="width:100%;"><i class="icon-copy dw dw-add"></i> Tambah Data</a>
                    </div>
                </div>
            </div>
          </div>
...
<script>
    $(document).ready(function() {
      ...
      table = $('.table-data-ku').DataTable({
          ...
          // scrollX: true,
          ajax: {
              url: "<?php echo base_url('manage-staf-json'); ?>",
              type: "POST",
              dataType: 'JSON',
              data: function (d) {
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content  text-white">
            ...
            <div class="modal-footer mx-auto py-1">
              ...
              <form action="<?= route_to('manage-delete-staf') ?>" method="post">
                <?= csrf_field() ?>
