      ...
      <div class="page-header">
        <div class="row">
          <div class="col-md-12 col-sm-12">
            ...
            <form action="<?= route_to('manage-bahan-presentasi-edit') ?>" method="post"  enctype="multipart/form-data">
              <?= csrf_field() ?>
              <input type="hidden" name="random" value="<?= $dt["random"] ?>" >
              <input type="hidden" name="dokumen" value="<?= $dt["file"] ?>" >
              <div class="form-group required mb-1">
                <label class="starlabel">Nama Bahan Presentasi</label>
                <input class="form-control <?php if(session('errors.namabahan')){ echo "form-control-danger";}else{} ?>" type="text" value="<?= $dt['namabahan'] ?>" name="namabahan" placeholder="Nama Bahan Presentasi">
              ...
              <button type="submit" class="btn btn-sm btn-success mt-3 ">Edit Bahan</button>
            </form>
