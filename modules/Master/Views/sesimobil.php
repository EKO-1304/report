            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="myLargeModalLabel">Tambah Data Sesi Mobil</h4>
                ...
                <div class="modal-body text-left">
                    ...
                    <form action="<?= route_to('manage-sesi-mobil-save') ?>" method="post" enctype="multipart/form-data">
                      <?= csrf_field() ?>

                      <div class="form-group required">
                        <label class="starlabel">Sesi Mobil</label>
                        <input class="form-control <?php if(session('errors.sesi')){ echo "form-control-danger";}else{} ?>" type="text" value="<?= old('sesi') ?>" name="sesi" placeholder="Sesi Mobil">
                        <small class="form-control-feedback text-danger"><?= session('errors.sesi') ?></small>
                      </div>
                      <div class="form-group  required">
                        <label class="starlabel">Status Sesi</label>
                        <select class="custom-select2 form-control <?php if(session('errors.status')){ echo "form-control-danger";}else{} ?>" name="status" style="width: 100%; height: 38px;">
                            <option value="">-- Select Status Sesi --</option>
            ...
            <tbody>
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content  text-white">
                      ...
                      <div class="modal-footer mx-auto py-1">
                        ...
                        <form action="<?= route_to('manage-sesi-mobil-delete') ?>" method="post">
                          <?= csrf_field() ?>
              ...
              <div class="modal fade" id="editdata<?= $random ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h4 class="modal-title" id="myLargeModalLabel">Edit Data Sesi Mobil</h4>
                      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    </div>
                    <div class="modal-body text-left">
                        <div  class="mb-2" >
                        ...
                        <form action="<?= route_to('manage-sesi-mobil-update') ?>" method="post" enctype="multipart/form-data">
                          <?= csrf_field() ?>
                          ...
                          <div class="form-group required">
                            <label class="starlabel">Sesi Mobil</label>
                            <input class="form-control <?php if(session('errors.sesi')){ echo "form-control-danger";}else{} ?>" type="text" value="<?= $row['sesi'] ?>" name="sesi" placeholder="Sesi Mobil">
                            <small class="form-control-feedback text-danger"><?= session('errors.sesi') ?></small>
                          </div>
                          <div class="form-group  required">
                            <label class="starlabel">Status Sesi</label>
