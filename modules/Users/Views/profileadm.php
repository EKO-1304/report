        ...
        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
          <div class="pd-20 card-box height-100-p">
            ...
            <div class="profile-info">
              ...
              <ul>
                <li>
                  <span>Kampus Cabang:</span>
                  <span class="text-dark" id="profile_namakampus"><?= $profile['namakampus'] ?><span>
                </li>
                <li>
                ...
                <li>
                  ...
                  <span class="text-dark" id="profile_notelp"><?= $profile['notelp'] ?><span>
                </li>
                <li>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade height-100-p <?php if(session()->getFlashdata('tapprofile') <> 'gantipassword' ){echo "show active";}else{} ?>" id="setting" role="tabpanel">
                    <div class="profile-setting" id="div-to-refresh">
                      ...
                      <form action="<?= route_to('manage-users-profile-edit-adm') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <ul class="profile-edit-list row">
                          <li class="weight-500 col-md-6 py-0">
                            ...
                            <input class="form-control" type="hidden" value="<?= $profile['random_adm'] ?>" name="random_adm">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control <?php if(session('errors.tanggallahir')){ echo "form-control-danger";}else{} ?> date-picker" value="<?= $profile['tanggallahir'] ?>" name="tanggallahir" type="text">
                            ...
                            <div class="form-group">
                              ...
                              <input class="form-control <?php if(session('errors.nomortelp')){ echo "form-control-danger";}else{} ?>" value="<?= $profile['notelp'] ?>" type="text" name="nomortelp">
