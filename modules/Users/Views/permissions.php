            ...
            <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title" id="myLargeModalLabel">Tambah Data Permissions</h4>
                ...
                <div class="modal-body text-left">
                    ...
                    <form action="<?= route_to('manage-tambah-permissions') ?>" method="post">
                      ...
                      <div class="form-group required">
                        <label class="starlabel">Nama Permissions</label>
                        <input class="form-control <?php if(session('errors.namapermissions')){ echo "form-control-danger";}else{} ?>" type="text" value="<?= old('namapermissions') ?>" name="namapermissions" placeholder="Nama Permissions">
                        <small class="form-control-feedback text-danger"><?= session('errors.namapermissions') ?></small>
                      </div>
                      <div class="form-group required">
              ...
              <tr>
                ...
                <div class="modal fade" id="editdata<?= $random ?>" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h4 class="modal-title" id="myLargeModalLabel">Edit Data Permissions</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                      </div>
                      <div class="modal-body text-left">
                          <div  class="mb-2" >
                          ...
                          <form action="<?= route_to('manage-edit-permissions') ?>" method="post">
                            ...
                            <div class="form-group required">
                              ...
                              <input class="form-control <?php if(session('errors.namapermissions')){ echo "form-control-danger";}else{} ?>" type="text" value="<?= $row['name'] ?>" name="namapermissions" placeholder="Nama Permissions">
                              <small class="form-control-feedback text-danger"><?= session('errors.namapermissions') ?></small>
                            </div>
                            <div class="form-group required">
                              <label class="starlabel">Description</label>
