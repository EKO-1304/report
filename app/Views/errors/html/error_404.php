...
<head>
	...
	<!-- CSS -->
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>/vendors/admin/styles/core.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>/vendors/admin/styles/icon-font.min.css">
	<link rel="stylesheet" type="text/css" href="<?php echo base_url()?>/vendors/admin/styles/style.css">
		...
		<div class="pd-10">
			<div class="error-page-wrap text-center">
				...
				<div class="pt-20 mx-auto max-width-200">
					<a href="javascript:history.back()" class="btn btn-primary btn-block btn-lg">Back To Home</a>
				</div>
			</div>
		</div>
	</div>
